...
const ZigzagTitle: React.FC<ZigzagTitleProps> = ({ className = "" }) => {
 ...
 // Génère un <g> de cercles pour une lettre
  ...
  // 4) Coordonnées « GRUBZ.IO », chaque lettre espacée de 450px
