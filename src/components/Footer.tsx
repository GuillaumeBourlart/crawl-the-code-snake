...
const Footer = () => {
  ...
  return (
    <footer className="w-full py-4 px-4 bg-gray-900/80 backdrop-blur-sm border-t border-gray-800/50">
      <div className="container mx-auto">
        <div className={`flex flex-wrap justify-center gap-x-4 gap-y-2 text-sm text-gray-400 ${isMobile ? 'text-[10px]' : ''}`}>
